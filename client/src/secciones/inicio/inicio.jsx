...
export default function Inicio() {
  return (
    <section
      id="home"
      className="flex flex-col justify-center items-center min-h-screen w-full py-20 md:flex-row px-6 lg:px-16 mx-auto gap-10"
    >
      <motion.div
        ...
        className="w-full md:flex-1 space-y-4 md:space-y-6 text-center md:text-left"
      >
        {/* TEXTO */}
      ...
      >
        <div className="absolute w-80 h-80 md:w-130 md:h-130 bg-cyan-400 rounded-full blur-2xl  opacity-20 animate-pulse"></div>
        {/* IMAGEN */}
        <div className="w-80 h-80 lg:w-130 lg:h-130 rounded-full border p-2  border-indigo-500/30 bg-indigo-900/30 backdrop-blur-sm flex items-center justify-center md:w-100 md:h-100 hover: scale-85">
          <img
            src={myPic}
            alt="My pic"
